/*!
 * fullpage.js Parallax Effect Extension 0.0.4
...
! function(n) {
    window.fp_parallaxExtension = function() {
        ...
        function a() {
            if (F) {
                var e = n(J).length ? n(J) : n(U).first();
                M(e, 0)
            }
        }

        function l() {
            var t = n(J).length ? n(J) : n(U).first(),
                o = T === $,
            ...
            i.each(function() {
                ...
                var e = n(this).find(P);
                if (e.length) {
                    var t = n(this).find(W).length ? n(this).find(W) : n(this).find(P).first();
                    r(t)
                }
            })
        }
        ...
        function p(e, t) {
            n(Z).data("final-x", 0), n(Z).data("final-y", 0), B = document.querySelectorAll(U), l()
        }

        function u(e, t) {
            gn = !0;
            var o = "left" === t.xMovement ? n(J).find(P).first() : n(J).find(P).last();
        ...
        function S() {
            ...
            var s = z - (B[i].offsetTop - t),
                c = s * N / z;
            T !== $ && (i -= 1);
            var d = T !== $ ? c : -N + c;
            M(n(U).eq(i), d), i - 1 >= 0 && M(n(B[i - 1]), e(!1)[T].offsetNormal), "undefined" != typeof B[i + 1] && M(n(B[i + 1]), e(!0)[T].offsetNormal), rn = !1
        }
        ...
        function M(n, e, t) {
            var o = b(e, 1),
                i = n.find(P);
            if (i.length) {
                var a = (n.index(U), i.filter(D));
                n = a.length ? a : i.first()
            }
            if (F) n.css({
                "background-position-y": o + "px"
            });
            else if (!n.hasClass(K) || n.hasClass(j) || "undefined" != typeof t) {
                var l = n.find(Z),
                    r = "undefined" != typeof l.data("final-x") ? l.data("final-x") : 0;
                l.toggleClass(X, "undefined" != typeof t).css({
        ...
        function q(n, e, t) {
            var o = b(e, 1),
                i = F ? n : n.find(Z);
            if (!E.scrollBar && E.autoScrolling || i.addClass("fp-bg-animate"), F) i.toggleClass(X, "undefined" != typeof t).css("background-position-x", o + "px");
            else {
                var a = 0,
                    l = i.data("final-y");
                "none" !== l && "undefined" != typeof l && (a = l), i.toggleClass(X, "undefined" != typeof t).css({
        ...
        function I(n) {
            return n.find(P).length ? n.find(P).length > 1 ? n.find(P) : [n.find(P)] : [n]
        }
        ...
        var T, N, R, z, O, B, F, V, k = this,
            ...
            $ = "reveal",
            nn = "cover",
            en = "fp-parallax-stylesheet",
            tn = "fp-parallax-transitions",
            on = "#" + tn,
            an = "fp-parallax-transition-class",
            ln = "#" + an,
            rn = !1,
            fn = 0,
            sn = !1,
        ...
        ! function() {
            ...
            if (mn && m(), !t.localIsResizing && !E.scrollBar && E.autoScrolling) {
                ...
                var o = e(sn),
                    i = o[T].offsetNormal;
                M(n(U).eq(t.sectionIndex), 0), M(n(U).eq(t.leavingSection - 1), i), dn = 1 === Math.abs(t.leavingSection - 1 - t.sectionIndex);
                for (var a = Math.min(t.leavingSection - 1, t.sectionIndex) + 1; a < Math.max(t.leavingSection - 1, t.sectionIndex); a++) M(n(U).eq(a), 0, "silent")
            }
        }, k.applyHorizontal = function(e) {
            if (!e.localIsResizing && "none" != e.xMovement) {
                if (V = "undefined" != typeof e.direction && e.direction !== e.xMovement, V && E.continuousHorizontal && !gn) return void(V = !1);
                cn = V ? "left" === e.direction : "left" === e.xMovement;
                var o = t(cn),
                    i = o[T].offsetNormal;
                q(n(J).find(P).eq(e.slideIndex), 0), q(n(J).find(P).eq(e.prevSlideIndex), i), pn = 1 === Math.abs(e.slideIndex - e.prevSlideIndex);
                for (var a = Math.min(e.slideIndex, e.prevSlideIndex) + 1; a < Math.max(e.slideIndex, e.prevSlideIndex); a++) q(n(J).find(P).eq(a), 0, "silent")
            }
        }, k.init = function() {
            if (z = xn.height(), O = xn.width(), T = E.parallaxOptions.type, N = o(E.parallaxOptions.percentage), R = i(E.parallaxOptions.percentage), B = document.querySelectorAll(E.sectionSelector), F = "background" === E.parallaxOptions.property, w(), c(), !F) {
                var n = ".fp-bg{top:0;bottom:0;width: 100%;position:absolute;z-index: -1;}.fp-section.fp-table, .fp-slide.fp-table, .fp-section .fp-tableCell, .fp-slide .fp-tableCell {position:relative;overflow: hidden;}";
                C(en, n), m()
            }
            x(), a(), l(), un = !0
        }, k.destroy = function() {
        ...
        var hn;
        k.afterSlideLoads = function() {
            var e = F ? I(n(J)) : n(J).find(Z);
            if (e.removeClass("fp-bg-animate"), (gn || V) && (r(n(J).find(W)), gn = !1), !pn) {
                var o = t(cn),
                    i = o[T].offsetNormal,
                    a = n(J).find(W),
                    l = cn ? a.nextAll() : a.prevAll();
